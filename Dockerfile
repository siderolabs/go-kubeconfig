...
#
# Generated on 2022-10-24T18:38:48Z by kres ef0ba25.
...
RUN FILES="$(goimports -l -local github.com/siderolabs/go-kubeconfig .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'goimports -w -local github.com/siderolabs/go-kubeconfig .':\n${FILES}"; exit 1)
